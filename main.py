...
if __name__ == "__main__":
    ...
    parser.add_argument("--move_method", help = "Move method (0 = RandomAll, 1 = RandomOne, 2 = RandomTwo, 3 = RandomThree), default is RandomAll", required=False, type=int, default=-1)
